...
import "./polygon/SafeMath.sol";

// ITRC-20 contract
import "./polygon/IERC20.sol";
...
contract Project {
    ...
    *   ercToken: An interface of ERC20 (use to make transfert of token between addresses)
    ...
    */
        ...
        returns (bool result)
    {
        ...
        if (ercToken.transfer(payable(receiverAddress), amount)) {
    ...
    */
    function invest(
        ...
        ercToken.transferFrom(msg.sender, address(this), amount);
    ...
    */
        ...
        returns (bool result)
    {
        ...
        if (ercToken.transfer(investorAddress, amount)) {
            currentBalance = currentBalance.sub(amount);
            return true;
        }
